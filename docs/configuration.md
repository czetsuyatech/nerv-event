...
Polling jitter uses `ThreadLocalRandom` from the standard `java.base` module. Minimal/custom Java 21 runtime images need no additional random-generator provider module for NERV schedulers.
