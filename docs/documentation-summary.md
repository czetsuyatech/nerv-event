...
This release-documentation baseline covers transactional Outbox, atomic database-local Inbox handling, optional keyed ordering, Kafka, standard/FIFO SQS production, automatic and manual retry, PostgreSQL migrations, retention, observability, and the optional administrative web surface.
